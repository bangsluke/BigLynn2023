...
const LinksData: LinkData[] = [
  {
    ...
    description: 'Map of the Gainsborough course for planning those shots',
    linkURL:
  ...
  },
  {
    ...
    description: 'Downloadable Gainsborough scorecard for recording the occasional par',
    linkURL:
  ...
  },
  {
    ...
    description: 'Guide to help you through each Gainsborough hole',
  ...
  },
  {
    ...
    description: 'Map of the Constable course for planning those shots',
    linkURL:
  ...
  },
  {
    ...
    description: 'Downloadable Constable scorecard for recording those multiple bogeys',
    linkURL:
  ...
  },
  {
    ...
    description: 'Guide to help you through each Constable hole',
