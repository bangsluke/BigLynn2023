...
import { NavGroupProps } from "fe/components/ui/NavGroup";
import NavItem from "fe/components/ui/NavItem";
...
export default function NavCollapse({ menu, level }: NavCollapseProps) {
	...
	return (
		<>
			<ListItemButton
				sx={{
					borderRadius: `${ThemingS.themeConfig.borderRadius}px`,
					mb: 0.5,
